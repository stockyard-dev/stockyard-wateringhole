...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> WATERINGHOLE</h1>
...
var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "title", "label": "Title", "type": "text"}, {"name": "url", "label": "Url", "type": "text"}, {"name": "description", "label": "Description", "type": "textarea"}, {"name": "category", "label": "Category", "type": "text"}, {"name": "tags", "label": "Tags", "type": "text"}, {"name": "votes", "label": "Votes", "type": "integer"}, {"name": "submitted_by", "label": "Submitted By", "type": "text"}, {"name": "status", "label": "Status", "type": "text"}, {"name": "created_at", "label": "Created At", "type": "text"}];
